...
version = setuptools_utils.__version__
...
def linkcode_resolve(domain, info):
    ...
    if os.path.isfile(os.path.join(os.path.dirname(__file__), '..', rel_filename + '.py')):
        return "https://github.com/KarrLab/setuptools_utils/blob/master/{}.py".format(rel_filename)
    else:
        return "https://github.com/KarrLab/setuptools_utils/blob/master/{}/__init__.py".format(rel_filename)
...
#
# html_title = u'setuptools_utils v0.0.1'
...
htmlhelp_basename = 'setuptools_utils-doc'
...
latex_documents = [
    (master_doc, 'setuptools_utils.tex', u'setuptools_utils documentation',
     u'Karr Lab', 'manual'),
]
...
man_pages = [
    (master_doc, 'setuptools_utils', u'setuptools_utils documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'setuptools_utils', u'setuptools_utils documentation',
     author, 'setuptools_utils', 'One line description of project.',
     'Miscellaneous'),
]
